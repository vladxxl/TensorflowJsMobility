...
exports.readInput = function (img) { return imageToInput(readImage(img), TotalChannels); };
...
exports.loadModel = function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                mn = new mobilenet.MobileNet(1, 1);
                mn.path = "file://" + ModelPath;
                return [4 /*yield*/, mn.load()];
            case 1:
                _a.sent();
                return [2 /*return*/, function (input) { return mn.infer(input, Layer).reshape([1024]); }];
        }
    });
}); };
